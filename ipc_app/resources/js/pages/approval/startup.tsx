...
export default function ApprovalStartup({
    batch,
    startupCheck,
    startupInspection,
    photoUrls,
    ...
    return (
        <IpcShell
            ...
            headerActions={<PrintPreviewButton href={`/batches/${batch.id}/approval/startup/print`} />}
        >
            <Head title={`Startup Inspection — ${batch.no_batch}`} />
