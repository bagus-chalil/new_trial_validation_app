...
export default function PrintFinished({
    batch,
    finishedCheck,
    photoUrls,
    printInfo,
    ...
    return (
        <IpcShell
            ...
            headerActions={<PrintPreviewButton href={`/batches/${batch.id}/print/finished/pdf`} label="Cetak" />}
        >
            <Head title={`Print — Finished Good Report — ${batch.no_batch}`} />
