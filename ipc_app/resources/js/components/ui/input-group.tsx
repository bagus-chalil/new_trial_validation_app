...
/**
 * Adapted from 21st.dev's registry mirror of shadcn's Input Group
 * (https://21st.dev/r/shadcn/input-group) — lets an Input/Textarea carry
 * leading/trailing icons, text, or buttons (unit suffixes, search icons,
 * inline "clear" buttons) without every call site hand-rolling its own
